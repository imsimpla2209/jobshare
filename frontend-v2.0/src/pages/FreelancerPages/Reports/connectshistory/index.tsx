    ...
    <>
      <div className="container card mt-5">
        ...
        <>
          ...
          <div className="row">
            <div className="connects-title mb-3 text-center text-muted">Available balance</div>
            <div className="mb-0 text-center text-primary">
              <span
                className="connects-balance--state-extra"
                style={{ color: '#12582D', fontSize: 30, fontWeight: 'bold' }}
              >
                126
              </span>
            </div>
          ...
          <hr />
          <div className="row">
            <div className="connects-title text-muted mt-3 mb-3 ">Tue, March 9</div>
            <div className="row">
              <div className="col-md-7">
                ...
                >
                  ...
                  <p className="ms-2">Need to make updates to a theme in thinkific</p>
                </button>
              </div>
            </div>
          ...
          <div className="row">
            <div className="connects-title text-muted mt-3 mb-3 ">Tue, March 15</div>
            <div className="row">
              <div className="col-md-7">
                <button
                  className="btn -btn-default no-border d-flex cursor-pointer"
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  <p style={{ color: '#12582D' }}> need to make update to the theme </p>
                  <div className="row">
                    <div className="col-4">
                      Connect amounts
                      <div
