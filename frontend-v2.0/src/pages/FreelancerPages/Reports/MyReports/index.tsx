      ...
      <section>
        ...
        <div className="container" style={{ backgroundColor: 'white' }}>
          <div className="row" style={{ paddingLeft: '20px' }}>
            <h3 className="mb-10 mt-4 fw-bold" style={{ lineHeight: '24px', fontSize: '17px', fontWeight: 700 }}>
              <Link to="/weeklysummary" style={{ textDecoration: 'none', color: '#38a000' }}>
                {t('weekSummary')}
              </Link>
            </h3>
          </div>
          ...
          <div className=" row border-top mt-4" style={{ paddingLeft: '20px' }}>
            <h3 className="mb-10 mt-4 text-muted" style={{ lineHeight: '24px', fontSize: '17px', fontWeight: 700 }}>
              <i className="fas fa-lock me-2" />
              <a className="text-muted" href="#" style={{ textDecoration: 'none', color: 'black' }}>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
                ...
                <div className="up-illustration up-sell-image">
                  ...
                  >
                    ...
                    <path
                      ...
                      fill="#33637a"
                    />
                    <rect x="59.2" y="71.1" width="30.4" height="9.2" fill="#0E4623" />
                    <path
                      ...
                      fill="#fff"
                    />
                    <path d="M59.7 75.3H22.5c-.4 0-.7.3-.7.7v36.6c0 .4.3.7.7.7h38v-38h-.8z" fill="#e0e0e0" />
                    <path d="M126.6 75.3H60.4v38h66.2c.4 0 .7-.3.7-.7V76c0-.4-.3-.7-.7-.7z" fill="#c4c4c4" />
                    <path d="M42.6 94.8h-38c-.4 0-.5-.2-.2-.5l17.5-18.9h38.6L42.6 94.8z" fill="#f9f9f9" />
                    <path d="M144.7 94.3c.3.3.2.5-.2.5H78.4l-18-19.5h66.8l17.5 19z" fill="#f9f9f9" />
                  </svg>
                </div>
              </div>
              ...
              <div>
                <span>Freelancer Plus supports this feature as well as many other perks.</span>
              </div>
            </div>
