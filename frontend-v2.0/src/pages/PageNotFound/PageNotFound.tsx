...
export default function PageNotFound() {
  ...
  return (
    <>
      <div className="container" style={{ paddingTop: '7em', paddingBottom: '8em' }}>
        <div className="row">
          <div className="col-md-11 col-md-offset-1 text-center">
            ...
            >
              ...
              <path d="M33.4 100.6l49.1-75.8 31.6 9.7-6.3 67.5z" fill="#0E4623"></path>
              <ellipse cx="70.3" cy="102.2" fill="#34ba08" rx="37.5" ry="9.4"></ellipse>
              <path
            ...
            <h2 className="m-lg-top m-md-bottom text-muted">This page doesn't exist.</h2>
            <p className="text-muted m-sm-bottom">
              Please{' '}
              <button className="btn upw-c-cn p-0" onClick={() => navigate(-1)}>
                return
              </button>{' '}
              to the previous page or visit <a href="/">JobShare.com</a>
            </p>
