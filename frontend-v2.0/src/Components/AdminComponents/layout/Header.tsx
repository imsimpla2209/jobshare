...
import { Avatar, Badge, Breadcrumb, Button, Col, Drawer, Dropdown, List, Row, Space, Switch, Typography } from 'antd'
      ...
      <Row gutter={[24, 0]}>
        <Col span={24} md={6}>
          <Breadcrumb>
            ...
            <Breadcrumb.Item className="text-capitalize">{name.replace('/', '')}</Breadcrumb.Item>
          </Breadcrumb>
        ...
        <Col span={24} md={18} className="header-control">
          <Button type="link" onClick={handleLogout}>
            <i className={`fas fa-sign-out-alt`} style={{ marginRight: 4 }}></i>
            Logout
          </Button>
          ...
          >
            <Space direction="vertical" style={{ width: '100%' }}>
              ...
              <div className="sidebar-color">
                ...
                <div className="theme-color mb-3">
                  <ButtonContainer>
                    <Button type="primary" onClick={() => handleSidenavColor('#1890ff')}>
                      1
                    </Button>
                    <Button style={{ background: '#52c41a' }} onClick={() => handleSidenavColor('#52c41a')}>
                      1
                    </Button>
                    <Button style={{ background: '#d9363e' }} onClick={() => handleSidenavColor('#d9363e')}>
                      1
                    </Button>
                    <Button style={{ background: '#fadb14' }} onClick={() => handleSidenavColor('#fadb14')}>
                      1
                    </Button>

                    <Button style={{ background: '#111' }} onClick={() => handleSidenavColor('#111')}>
                      1
                    </Button>
                  </ButtonContainer>
                </div>

                <div className="fixed-nav mb-3" style={{ display: 'flex', justifyContent: 'space-between' }}>
