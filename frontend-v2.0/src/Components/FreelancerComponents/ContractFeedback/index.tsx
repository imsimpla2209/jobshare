    ...
    <div className="row pt-4 pb-5 ps-4 mt-3">
        ...
        {job?.status === false && job?.clientJobReview?.review ? (
          <>
            ...
            <div>
              <div>
                <small>
                  <i className="fas fa-star text-bgJobShare"></i>
                  <i className="fas fa-star text-bgJobShare"></i>
                  <i className="fas fa-star text-bgJobShare"></i>
                  <i className="fas fa-star text-bgJobShare"></i>
                  <i className="fas fa-star text-bgJobShare"></i>
      ...
      {job?.status !== false && (
        <div className="col-12 text-center">
          <svg role="img" viewBox="0 0 145 130" xmlns="http://www.w3.org/2000/svg" width="200" height="200">
            <circle cx="72.5" cy="65" fill="gray" r="64.5"></circle>
            <path d="M8.7 74.3c4.5 31.2 31.4 55.2 63.8 55.2 32.5 0 59.3-24 63.8-55.2H8.7z" fill="darkgray"></path>
            <path
            ...
            <path
              ...
              fill="#6058c4"
            ></path>
            <path d="M63.3 94.9s.3-.1.3-.4c0-.2-.1-.3-.3-.4l-5.2-2.4v5.5l5.2-2.3z" fill="#6058c4"></path>
            <rect height="28.1" width="5.5" fill="gray" transform="rotate(90 44.116 94.49)" x="41.4" y="80.4"></rect>
            <path d="M27.2 95.1v-1.3c0-1.2.9-2.1 2.1-2.1h.8v5.5h-.8c-1.2 0-2.1-.9-2.1-2.1z" fill="#6058c4"></path>
          </svg>
