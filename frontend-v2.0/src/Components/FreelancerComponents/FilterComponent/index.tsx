    ...
    <div>
      <p>
        <button
          ...
          style={{
            color: 'white',
            background: 'linear-gradient(92.88deg, #12582D 9.16%, #316027 43.89%, #1F8346 64.72%)008329',
          }}
        >
              ...
              <div className="dropdown text-start">
                ...
                >
                  <li>
                    ...
                    ></i>
                    <input type="search" id="form1" style={{ paddingLeft: '3px' }} className="form-control" />
                  </li>
