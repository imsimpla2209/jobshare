...
import freelancerainSectionFlexeraDevIT from "../../../assets/img/talent-main-section-flexera-Dev-IT.png";
import freelancerMainSectionArticle2FlexeraHeaderDevIT from "../../../assets/img/talent-main-section-article2-flexera-header-Dev-IT.svg";
    ...
    <div>
      <div className="row mx-md-5 mx-1 my-5 py-md-5 d-flex flex-wrap-reverse">
        <div className="col-lg-6 col-12 position-relative">
          <img src={freelancerainSectionFlexeraDevIT} className="w-100" alt="" />
          <div
        ...
        <div className="col-lg-6 col-12 pt-md-5">
          <div className="row pt-md-5 ms-3">
            <div className="col-4">
              <img src={freelancerMainSectionArticle2FlexeraHeaderDevIT} alt="" />
            </div>
          </div>
          ...
          >
            By leveraging remote freelancer, Flexera found the specialized skills
