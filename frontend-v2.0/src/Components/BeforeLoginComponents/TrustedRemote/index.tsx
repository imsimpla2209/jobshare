      ...
      <div className="row mx-md-5 mx-1 my-md-5 my-3 py-md-5" id="Remote-professionals-section-ID">
        ...
        <div className="row mb-3" id="evaluation-ID">
          <div className="col-lg-3 col-md-4 col-6 mb-3">
            <EvaluationCard
              headerTag={<i className="fas fa-star fs-5" />}
              header="4.91/5"
              content="Average client satisfaction on development and IT projects"
            />
          </div>
          <div className="col-lg-3 col-md-4 col-6 mb-3">
          ...
          <div className="col-lg-3 col-md-4 mb-3">
            <EvaluationCard
              header="1,665 skills"
              content=" Represented across JobShare's pool of development and IT freelancer"
            />
          </div>
        </div>
        <div className="d-flex flex-lg-wrap flex-row flex-nowrap overflow-auto mx-1 mb-3" id="scrollable-experts-ID">
          <div className="col-lg-3 col-md-5 col-6 px-3 shadow-sm rounded-3 py-3 mb-2">
            <ExpertsCard
              expert1={freelancerMainSectionExperts1DevIT}
              expert2={freelancerMainSectionExperts2DevIT}
              expert3={freelancerMainSectionExperts3DevIT}
            />
          </div>
          <div className="col-lg-3 col-md-5 col-6 px-3 shadow-sm rounded-3 py-3 mb-2">
            <ExpertsCard
        ...
        <div className="d-flex fs-5 mb-5">
          ...
          <a href="#" className="text-decoration-none">
            Browse all skills <i className="fas fa-arrow-down" />
          </a>
        </div>
      </div>
    </div>
