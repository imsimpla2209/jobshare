...
import freelancerMainSectionBuyProjectByDevIT from "../../../assets/img/talent-main-section-buy-project-by-Dev-IT.png";
import freelancerMainSectionBuyProjectDevIT from "../../../assets/img/talent-main-section-buy-project-Dev-IT.png";
      ...
      >
        ...
        <div className="row mb-3" id="medium-Project-Catalog-section-ID">
          ...
          <div className="col-lg-8 col-12 position-relative">
            <img
              className="w-100"
              src={freelancerMainSectionBuyProjectDevIT}
              alt=""
            />
            <div
              ...
              <div className="row d-flex justify-content-between">
                <div className="col-3">
                  <img
                    ...
                    src={freelancerMainSectionBuyProjectByDevIT}
                    alt=""
        ...
        <div className="row mx-1" id="lower-Project-Catalog-section-ID">
          ...
          <div className="col-lg-8 col-12">
            ...
            <div className="row" id="Browse-buy-projects-button-ID">
              <button
                className="btn col-lg-2 col-12 mx-lg-0 mx-auto fw-bolder mb-3 bg-jobsicker"
                type="button"
              >
                Learn more
              </button>
