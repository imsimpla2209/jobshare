...
import freelancerHeaderPlayingFieldDevIT from '../../../assets/img/talent-header-playing-field-Dev-IT.svg'
      ...
      <div className="row mx-md-5 mx-1 my-5 py-5 px-5 bg-light rounded" id="playing-field-section-ID">
        <div className="col-lg-6 col-12 px-5">
          ...
          <div className="row mb-3 mx-1 fs-6 text-secondary" id="playing-field-paragraph-ID">
            ...
            work strategically with independent freelancer.
    </div>
        ...
        <div className="col-md-6 position-relative">
          <img className="position-absolute w-lg-100 " id="playing-field-ID" src={freelancerHeaderPlayingFieldDevIT} alt='' />
        </div>
      </div>
