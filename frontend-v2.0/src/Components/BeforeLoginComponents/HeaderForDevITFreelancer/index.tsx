...
import './HeaderForDevItFreelancer.css'
import freelancerHeaderDevIT from '../../../assets/img/talent-header-Dev-IT.png'
import freelancerHeaderBgSvg1DevIT from "../../../assets/img/talent-header-bg-svg1-Dev-IT.svg"
import freelancerHeaderBgSvg2DevIT from "../../../assets/img/talent-header-bg-svg2-Dev-IT.svg"
import { Link } from 'react-router-dom'

export default function HeaderForDevItFreelancer() {
    return (
        <div>
                    ...
                    <div className="row d-flex justify-content-evenly mb-lg-5 pb-5 pt-5 me-3 ms-3" id="body-header-ID">
                        <div className="col-xl-5 col-lg-6 position-relative col-12" id="header-text-ID">
                            <h1 className="fw-bolder display-4 text-lg-start text-center">
                                Specialized development and IT freelancer, for any scope.
                            </h1>
                        ...
                        <div className="col-xl-5 col-lg-4" id="header-images-ID">
                            <img src={freelancerHeaderDevIT} id="header-man-ID" className="rounded mx-auto d-lg-block position-relative d-none" width={320} alt='' />
                            <img src={freelancerHeaderBgSvg1DevIT} id="header-svg-1-ID" className="position-absolute" alt='' />
                            <img src={freelancerHeaderBgSvg2DevIT} id="header-svg-2-ID" className="position-absolute" alt='' />
                        </div>
                    </div>
                </div>
            </section>
