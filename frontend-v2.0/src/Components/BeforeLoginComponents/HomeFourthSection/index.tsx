          ...
          <div>
            <div className="position-relative">
              <div className="w-50 ms-auto my-5 ps-5 pb-5 fth-div-cn">
                <p>{t('ThefreelancefreelancerthatImabletoaccess')}</p>
                <span>
            ...
            <div className="text-center mb-5">
              <span>4.6 / 5</span>
              <span className="mx-3" style={{ color: '#0E4623' }}>
        ...
        <div className="row">
          ...
          <div>
            <div className="text-center mt-4 mx-auto" style={{ width: '88%' }}>
              ...
              <a style={{ color: '#12582D' }} href="#">
                <strong>{t('Seemore')}</strong>
              </a>
            </div>
            <div className="text-center m-5">
              <button className="btn border shadow-none px-4 py-2 fs-5" style={{ color: '#12582D' }}>
                {t('Browseall')}
              </button>
            </div>
          </div>
