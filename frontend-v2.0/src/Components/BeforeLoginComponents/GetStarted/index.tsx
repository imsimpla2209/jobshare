...
import freelancerMainSectionVideoPreviewDevIT from '../../../assets/img/talent_main-section-video-preview-Dev-IT.jpeg'
				...
				<div className="col-lg-5 col-12">
					...
					<div className="row mb-3" id="get-started-header-ID">
						<h1 className="fw-bolder">
							Tap into the world's largest freelancer network
						</h1>
					</div>
					<div className="row mb-3" id="get-started-sub-header-ID">
						<h4 className="fw-bold">Find and hire specialized freelancer.</h4>
					</div>
					<div className="row mb-3 mx-1" id="get-started-list-ID">
						<ul className="fs-6 ms-3">
							<li>Quickly generate a shortlist of qualified freelancer</li>
					...
					<div className="row mb-3 mx-1" id="get-started-button-ID">
						<button className="btn col-lg-6 col-12 mx-lg-0 mx-auto fw-bolder mb-3 bg-jobsicker" type="button">
							Connect with Freelancer
						</button>
					</div>
				</div>
				<div className="col-lg-7 col-12">
					<video className="w-100" poster={freelancerMainSectionVideoPreviewDevIT} controls>
