        ...
        <div className="container">
          <div className="row footer-menu-cn">
            ...
            <div className="col-md-3 col-sm-12">
              <ul className="list-unstyled">
                <li>
                  <a href="#">{t('Trust, Safety & Security')}</a>
                </li>
                <li>
                  <a href="#">{t('Help & Support')}</a>
                </li>
                <li>
                  <a href="#">{t('JobShare Foundation')}</a>
                </li>
              </ul>
            </div>
            <div className="col-md-3 col-sm-12">
            ...
            <div className="col-md-3 col-sm-12">
              <ul className="list-unstyled">
                <li>
                  <a href="#">{t('Desktop App')}</a>
                </li>
                <li>
                  <a href="#">{t('Cookie Policy')}</a>
                </li>
                <li>
                  <a href="#">{t('Enterprise Solutions')}</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="row">
            <p className="text-light text-center mt-4">{t('© 2015 - 2021 JobShare® Global Inc.')}</p>
          </div>
        </div>
      </footer>
    </>
