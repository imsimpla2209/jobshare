  ...
  return (
    <div className="text-center">
      <svg className="py-4 mt-5" width="145px" role="img" viewBox="0 0 145 130" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M7.6 83.4c7.9 26.6 32.6 46.1 61.8 46.1 29.2 0 53.9-19.4 61.8-46.1H7.6z" fill="#33637a"></path>
        <path
        ...
        <path
          ...
          fill="#e0e0e0"
        ></path>
        <path d="M88.614 74.97l5.586 5.587-2.758 2.758-5.586-5.586z" fill="#e0e0e0"></path>
        <ellipse
          cx="83.3"
          cy="85.8"
          fill="#c4c4c4"
